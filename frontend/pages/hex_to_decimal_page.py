"""
Hexadecimal to Decimal conversion page.
"""
...
class HexToDecimalPage(QWidget):
    """
    Page for converting hexadecimal numbers to decimal representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Hexadecimal to Decimal page."""
        ...
        # Title
        title = QLabel("Hexadecimal to Decimal Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter hex number (e.g., FF or 0xFF)\nSupports multiple lines...")
    ...
    def perform_conversion(self):
        """Perform the hexadecimal to decimal conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_hexadecimal_to_decimal(user_input)
