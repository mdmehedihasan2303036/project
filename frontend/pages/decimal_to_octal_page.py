"""
Decimal to Octal conversion page.
"""
...
class DecimalToOctalPage(QWidget):
    """
    Page for converting decimal numbers to octal representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Decimal to Octal page."""
        ...
        # Title
        title = QLabel("Decimal to Octal Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter decimal number (e.g., 64)\nSupports multiple lines...")

        # Convert button
        self.convert_button = QPushButton("Convert to Octal")
    ...
    def perform_conversion(self):
        """Perform the decimal to octal conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_decimal_to_octal(user_input)
