"""
Decimal to Binary conversion page.
"""
...
class DecimalToBinaryPage(QWidget):
    """
    Page for converting decimal numbers to binary representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Decimal to Binary page."""
        ...
        # Title
        title = QLabel("Decimal to Binary Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter decimal number (e.g., 42)\nSupports multiple lines...")
    ...
    def perform_conversion(self):
        ...
        try:
            ...
            result = convert_decimal_to_binary(user_input)
