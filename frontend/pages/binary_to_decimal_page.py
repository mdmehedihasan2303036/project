"""
Binary to Decimal conversion page.
"""
...
class BinaryToDecimalPage(QWidget):
    """
    Page for converting binary numbers to decimal representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Binary to Decimal page."""
        ...
        # Title
        title = QLabel("Binary to Decimal Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter binary number (e.g., 101010)\nSupports multiple lines...")
        # Convert button
    ...
    def perform_conversion(self):
        ...
        try:
            ...
            result = convert_binary_to_decimal(user_input)
