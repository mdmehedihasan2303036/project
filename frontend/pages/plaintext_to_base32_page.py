"""
PlainText to Base32 conversion page.
"""
...
from backend.routes.plaintext_to_base32 import convert_plaintext_to_base32


class PlaintextToBase32Page(QWidget):
    """
    Page for converting plaintext to Base32 representation.
    """

    logout_requested = pyqtSignal()

    def __init__(self, parent=None):
        """Initialize the PlainText to Base32 page."""
        super().__init__(parent)

        layout = QVBoxLayout()
        layout.setSpacing(15)

        title = QLabel("PlainText to Base32 Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        self.convert_button = QPushButton("Convert to Base32")
    ...
    def perform_conversion(self):
        """Perform the plaintext to Base32 conversion."""
        ...
        try:
            result = convert_plaintext_to_base32(user_input)
