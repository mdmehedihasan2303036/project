"""
Decimal to Hexadecimal conversion page.
"""
...
class DecimalToHexPage(QWidget):
    """
    Page for converting decimal numbers to hexadecimal representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Decimal to Hexadecimal page."""
        ...
        # Title
        title = QLabel("Decimal to Hexadecimal Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter decimal number (e.g., 255)\nSupports multiple lines...")
    ...
    def perform_conversion(self):
        ...
        try:
            ...
            result = convert_decimal_to_hexadecimal(user_input)
