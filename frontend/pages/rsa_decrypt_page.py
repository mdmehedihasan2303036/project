"""
RSA Decryption page - Use e and d to Msg.
"""

from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel,
                              QPushButton, QLineEdit, QTextEdit, QApplication)
from PyQt6.QtCore import Qt, pyqtSignal
from backend.routes.rsa_conversion import rsa_decrypt


class RSADecryptPage(QWidget):
    """
    Page for RSA decryption using d and N parameters.
    Formula: Msg = (Cipher)^d mod N
    """

    logout_requested = pyqtSignal()

    def __init__(self, parent=None):
        """Initialize the RSA decryption page."""
        ...
        # Title
        title = QLabel("Use e and d to Msg")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        self.convert_button = QPushButton("Convert to Message")
    ...
    def _on_convert(self):
        ...
        # Decryption mode
        result = rsa_decrypt(msg_text, d_text, n_text)
