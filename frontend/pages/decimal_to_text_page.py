"""
Decimal to Text conversion page.
"""
...
from backend.routes.decimal_to_text import convert_decimal_to_text
from backend.utils.exceptions import CryptInfoBDException


class DecimalToTextPage(QWidget):
    """
    Page for converting decimal ASCII codes to text.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Decimal to Text page."""
        ...
        # Title
        title = QLabel("Decimal to Text Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter decimal ASCII codes (e.g., 72 101 108 108 111)\\nSeparate multiple codes with spaces")
    ...
    def perform_conversion(self):
        """Perform the decimal to text conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_decimal_to_text(user_input)
