"""
PlainText to Base64 conversion page.
"""
...
from backend.routes.plaintext_to_base64 import convert_plaintext_to_base64


class PlaintextToBase64Page(QWidget):
    """
    Page for converting plaintext to Base64 representation.
    """

    logout_requested = pyqtSignal()

    def __init__(self, parent=None):
        """Initialize the PlainText to Base64 page."""
        super().__init__(parent)

        layout = QVBoxLayout()
        layout.setSpacing(15)

        title = QLabel("PlainText to Base64 Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        self.convert_button = QPushButton("Convert to Base64")
    ...
    def perform_conversion(self):
        """Perform the plaintext to Base64 conversion."""
        ...
        try:
            result = convert_plaintext_to_base64(user_input)
