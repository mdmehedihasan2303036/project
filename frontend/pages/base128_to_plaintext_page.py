"""
Base128 to PlainText conversion page.
"""
...
from backend.routes.base128_to_plaintext import convert_base128_to_plaintext


class Base128ToPlaintextPage(QWidget):
    """
    Page for converting Base128 to plaintext representation.
    """

    logout_requested = pyqtSignal()

    def __init__(self, parent=None):
        """Initialize the Base128 to PlainText page."""
        super().__init__(parent)

        layout = QVBoxLayout()
        layout.setSpacing(15)

        title = QLabel("Base128 to PlainText Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        self.input_field = InputField("Enter Base128 to convert...")

        self.convert_button = QPushButton("Convert to PlainText")
    ...
    def perform_conversion(self):
        """Perform the Base128 to plaintext conversion."""
        ...
        try:
            result = convert_base128_to_plaintext(user_input)
