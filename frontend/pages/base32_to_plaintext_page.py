"""
Base32 to PlainText conversion page.
"""
...
from backend.routes.base32_to_plaintext import convert_base32_to_plaintext


class Base32ToPlaintextPage(QWidget):
    """
    Page for converting Base32 to plaintext representation.
    """

    logout_requested = pyqtSignal()

    def __init__(self, parent=None):
        """Initialize the Base32 to PlainText page."""
        super().__init__(parent)

        layout = QVBoxLayout()
        layout.setSpacing(15)

        title = QLabel("Base32 to PlainText Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        self.input_field = InputField("Enter Base32 to convert...")
    ...
    def perform_conversion(self):
        """Perform the Base32 to plaintext conversion."""
        ...
        try:
            result = convert_base32_to_plaintext(user_input)
