"""
Binary to Text conversion page.
"""
...
from backend.routes.binary_to_text import convert_binary_to_text
from backend.utils.exceptions import CryptInfoBDException


class BinaryToTextPage(QWidget):
    """
    Page for converting binary ASCII codes to text.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Binary to Text page."""
        ...
        # Title
        title = QLabel("Binary to Text Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter binary ASCII codes (e.g., 1001000 1100101 1101100 1101100 1101111)\\nSeparate multiple codes with spaces")
    ...
    def perform_conversion(self):
        """Perform the binary to text conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_binary_to_text(user_input)
