"""
Octal to Decimal conversion page.
"""
...
class OctalToDecimalPage(QWidget):
    """
    Page for converting octal numbers to decimal representation.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Octal to Decimal page."""
        ...
        # Title
        title = QLabel("Octal to Decimal Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter octal number (e.g., 77 or 0o77)\nSupports multiple lines...")
    ...
    def perform_conversion(self):
        """Perform the octal to decimal conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_octal_to_decimal(user_input)
