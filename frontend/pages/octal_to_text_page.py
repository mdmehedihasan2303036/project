...
from backend.routes.octal_to_text import convert_octal_to_text
from backend.utils.exceptions import CryptInfoBDException


class OctalToTextPage(QWidget):
    """
    Page for converting octal ASCII codes to text.
    """
    ...
    def __init__(self, parent=None):
        """Initialize the Octal to Text page."""
        ...
        # Title
        title = QLabel("Octal to Text Converter")
        title.setStyleSheet("""
            QLabel {
                font-size: 20px;
                font-weight: bold;
        ...
        # Input field
        self.input_field = InputField("Enter octal ASCII codes (e.g., 110 145 154 154 157)\\nSeparate multiple codes with spaces")
    ...
    def perform_conversion(self):
        """Perform the octal to text conversion."""
        # Reset output style
        ...
        try:
            ...
            result = convert_octal_to_text(user_input)
